...
int main( void )
{
	...
	xTaskCreate((pdTASK_CODE)app_th_task, "sht10", 280, NULL, 4, &task_handle[TASK_HANDLE_SHT10]);
	xTaskCreate((pdTASK_CODE)app_time_task, "time", 280, NULL, 3, &task_handle[TASK_HANDLE_DS3231]);
