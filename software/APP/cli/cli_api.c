...
static BaseType_t prvHelpCommand(const char * const pcCommandInput, char *pcWriteBuffer, size_t xWriteBufferLen, const char * const pHelpString);
...
added to this list. */
static CLI_Definition_List_Item_t cHeadListCommands = 
{
    &xHelpCommand,
    NULL,
};
...
/*-----------------------------------------------------------*/
CLI_Definition_List_Item_t *cli_api_get_cmd_list(void)
{
...
BaseType_t FreeRTOS_CLIProcessCommand( const char * const pcCommandInput, char * pcWriteBuffer, size_t xWriteBufferLen  )
{
	...
	else
	{
        ...
        if(*pcCommandInput != 0)
        {
            ...
            memset(pcWriteBuffer, '\0', sizeof(char) * configCOMMAND_INT_MAX_OUTPUT_SIZE);
		xReturn = pdFALSE;
	}
...
static BaseType_t prvHelpCommand(const char * const pcCommandInput, char *pcWriteBuffer, size_t xWriteBufferLen, const char * const pHelpString)
{
	CLI_Definition_List_Item_t *cmd_index = NULL;
	...
	for(cmd_index = cli_api_get_cmd_list(); cmd_index != NULL; cmd_index = cmd_index->pxNext )
    {
